...
<main class="container">
    ...
    <nav class="pagination is-small" role="navigation" aria-label="pagination">
        ...
        <ul class="pagination-list">
            ...
            <?php if($page > 1 && $page < $last_page){ ?>
                <li><a href="thread.php?pag=<?= $page ?>&id-theme=<?= $theme_id ?>" class="pagination-link" aria-label="Ir a página <?= $page ?>"><?= $page ?></a></li>
            <?php } ?>
            <!-- seleccionado -->
            ...
            <?php if($page + 2 < $last_page){ ?>
                <li><a href="thread.php?pag=<?= $page + 2 ?>&id-theme=<?= $theme_id ?>" class="pagination-link" aria-label="Ir a página <?= $page + 2 ?>"><?= $page + 2 ?></a></li>
            <?php } ?>
            <!-- ... -->
    ...
    <?php foreach ($threads as $thread){ ?>
        <article class="message">
            <div class="message-header">
                <a href="sub_thread.php?id-thread=<?= $thread['id'] ?>">
    ...
    <?php if($user !== null){ ?>
        ...
        <form action="../controller/ThreadController.php" method="post" class="user-form box" id="new-thread">
            ...
            <div class="field">
                ...
                <div class="control">
                    <textarea class="input" type="text" name="content" id="content" rows="8" cols="50" required></textarea>
                </div>
            ...
            <div class="field is-grouped">
                ...
                <div class="control">
                    <button class="button is-link is-light"
                            onclick="document.getElementById('description').value = ''; document.getElementById('title').value = '';">
                        Limpiar
                    </button>
                </div>
            </div>
